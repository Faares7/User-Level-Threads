...
Commit 2
Name: Threads Implementation V2
Commit Message: Including types.h and state.h files
Code:
#include "types.h"
#include "stat.h"
#include "user/user.h"
...
Commit 3
Name: Threads Implementation V3
Commit Message: Modifying types.h and state.h files pathes to be in the kernel folder
Code:
